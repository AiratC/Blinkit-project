...
const EditAddressDetails = ({ close, data }) => {
   ...
   return (
      <section className='bg-black fixed top-0 left-0 right-0 bottom-0 z-50 bg-opacity-70 h-screen overflow-auto'>
         <div ref={editAddressRef} className='bg-white p-4 w-full max-w-lg mt-8 mx-auto rounded'>
            <div className='flex justify-between items-center gap-4'>
               <h2 className='font-semibold'>Редактировать адрес</h2>
            ...
            <form className='mt-4 grid gap-4' onSubmit={handleSubmit(onSubmit)}>
               ...
               <button type='submit' className='bg-primary-200 w-full  py-2 font-semibold mt-4 hover:bg-primary-100'>Отправить</button>
            </form>
         </div>
      </section>
   )
